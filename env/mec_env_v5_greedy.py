...
class MECEnv(object):
    ...
    def __init__(self,
                 num_device=5,
                 edge_computing_capacity=5000,
                 cloud_computing_capacity=30000,
                 transmit_rate=0.5,
                 edge_CPU_coefficient=10e-16,
...
if __name__ == '__main__':
    ...
    for i_episode in range(num_episodes):
        ...
        if (i_episode + 1) % 10 == 0:
            print("Episode: {}, Score: {}".format(i_episode + 1, np.mean(episodic_rewards)))
        np.savetxt("greedy_rate0.7_10.txt", episodic_rewards, fmt="%.2f")
