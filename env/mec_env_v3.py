...
class MECEnv:
    ...
    def __init__(self,
        ...
        self.transmit_rate = transmit_rate  # 5MB/s
        ...
        self.request_queue = []
        self.precess_queue = []
        self.queue_max_size = 5 # 信道最大任务个数
        self.transmit_queue = []
        self.task_feature_dim = 8
        self.info = dict()
    ...
    def generate_task(self):
        # 任务随机到达
        self.generate_task_prob = np.array([self.task_generation_rate] * self.num_device) # 任务到达率
    ...
    def update_transmit(self):
        ...
        if len(self.transmit_queue) != 0:
            ...
            # 选择传送完成的(只计算位于队列首部的任务cost，cost中加入一个惩罚项)
